...
const FarmerSignup = () => {
  ...
  useEffect(() => {
    document.title = 'Farmer Signup - BharatKrishi';
  }, []);
        ...
        <div className="container mx-auto px-4">
          <Card className="max-w-md mx-auto">
            <CardContent className="pt-6">
              ...
              <h2 className="text-xl font-semibold text-center mb-6">Farmer Registration</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label htmlFor="cropTypes" className="block text-sm font-medium text-gray-700 mb-1">
